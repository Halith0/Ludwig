...
function LudwigUI_UpdateList(changed)
	...
	local size = #display
	local total = LudwigDB["concerned_items"]
	local formatted = string.format("%.2f%%",(100-(size/total*100)))
	uiFrame.title:SetText(size.." Left ".."("..formatted.." Attuned"..")")
